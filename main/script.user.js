// ==UserScript==
// @name         Web — Resumir la página con IA
// @namespace    https://factorlibre.com/gextia
// @version      2026-09-21
// @description  PUENTE DE MIGRACIÓN — el script vive ahora en web-resume-ia/web-resume-ia.user.js
...
// @updateURL    https://git.factorlibre.com/jesus.lorenzo/tm-estado-sitios/-/raw/master/web-resume-ia/web-resume-ia.user.js
// @downloadURL  https://git.factorlibre.com/jesus.lorenzo/tm-estado-sitios/-/raw/master/web-resume-ia/web-resume-ia.user.js
// @match        *://*/*
// ==/UserScript==
 ...
 *   https://git.factorlibre.com/jesus.lorenzo/tm-estado-sitios/-/raw/master/web-resume-ia/web-resume-ia.user.js
 *
 * Requiere sesión iniciada en git.factorlibre.com.
 */
console.info(
    "[web-resume-ia] Este fichero es un puente de migración. El script está en " +
        "https://git.factorlibre.com/jesus.lorenzo/tm-estado-sitios/-/raw/master/web-resume-ia/web-resume-ia.user.js"
);
